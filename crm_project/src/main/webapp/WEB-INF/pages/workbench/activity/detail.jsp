...
<script type="text/javascript">
	...
	//	给所有的“删除图标”添加单击事件
		...
		$("#remarkListDiv").on("click","a[name='editA']",function (){
			...
			console.log($("#div_"+id).attr("class"))
	...
	<div id="remarkListDiv" style="position: relative; top: 30px; left: 40px;">
		...
		<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				...
				<font color="gray">市场活动</font> <font color="gray">-</font> <b>${requestScope.activity.name}</b> <small style="color: gray;">${remark.editFlag=='0'?remark.createTime:remark.editTime}  由${remark.editFlag=='0'?remark.createBy:remark.editBy} ${remark.editFlag=='0'?'创建':'修改'}</small>
